...
from pymodelextractor.learners.observation_tree_learners.kearns_vazirani_learner_optimization import \
    KearnsVaziraniLearnerOpt
...
class TestKearnsVaziraniLearnerOptimization(unittest.TestCase):
    def setUp(self):
        self.learner = KearnsVaziraniLearnerOpt()
